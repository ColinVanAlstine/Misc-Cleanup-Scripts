...
items['subclass'] = items['Z30_CALL_NO'].str.slice(0, 2)
items['subclass'] = items['subclass'].str.upper()
items['subclass'] = items['subclass'].str.replace('\d+', '')
items['subclass'] = items['subclass'].str.replace(' ', '')
...
item_count = items.groupby('subclass')['Z30_REC_KEY'].nunique()
title_count = items.groupby('subclass')['ADM'].nunique()
...
main_class_counts.to_csv('z30_all_lc_output.csv')